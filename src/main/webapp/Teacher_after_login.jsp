...
<div class="navbar">
    <!-- <center><p>Logged as Teacher ${teacherObj.getName()}</p></center> -->
    <a href="/teacherLogout" class="right">logout</a>
</div>
<div class="main">
<div class="verticaltab">
        <div class="tab">
            <button class="tablinks" onclick="openCity(event, 'one')" id="defaultOpen">Important Note</button>
            <button class="tablinks" onclick="openCity(event, 'two')">Students List</button>
            <button class="tablinks" onclick="openCity(event, 'three')">MY TimeTable</button>
            ...
            <button class="tablinks" onclick="openCity(event, 'six')"></button>
          </div>  
          <div id="one" class="tabcontent">
            <div style="padding-left:10px;">
            <h3>HI <span style="color:red;">${teacherObj.getName()}</span> welcome</h3>
            </div>
          </div>
          ...
          <div id="three" class="tabcontent">
			<table style="margin-top:10px;border-collapse: collapse;width:100%;">
				...
				<c:forEach items="${timetable}" var="entry">
					...
					<td><a href="/delete?date=${entry.getDate()}&id=${entry.getId()}"><input type="button" value="Delete"></a></td></tr>
				</c:forEach>
			</table>
			<br><br>
			<form action="/addTimeTable" class="form-container">
            ...
            <table style="margin-top:10px;border-collapse: collapse;width:100%;">
                   <caption>Subjects</caption>
					<tr style="color:red;"><td>ID</td><td>NAME</td><td>Fee Offered</td></tr>
						...
						<tr><td>${entry.getId()}</td><td>${entry.getName()}</td><td>${entry.getFee()}</td></tr>
						</c:forEach> 
			</table>
          </div>
